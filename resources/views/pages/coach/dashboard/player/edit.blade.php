        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('coach.player.update',['test','coach']) }}" autocomplete="off" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <input name="coachs_id" type="hidden" value="{{\Illuminate\Support\Facades\Auth::user()->id}}">
