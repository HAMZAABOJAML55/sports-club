                ...
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <a href="{{route('coach.player.create','test')}}" class="btn btn-success btn-sm" role="button"
                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                            ...
                                            <td>
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item" href="{{route('coach.player.edit',[$player->id,'test'])}}"><i style="color:green" class="fa fa-edit"></i>&nbsp;  تعديل بيانات الطالب</a>
                                    ...
                                    @include('pages.coach.dashboard.player.Delete')
                                    @endforeach
                                </table>
                            </div>
                        </div>
