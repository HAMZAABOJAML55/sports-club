...
{{--                                  <form method="post" action="{{route('image.update',$product->id)}}">--}}
{{--                                        @csrf--}}
{{--                                        @method('PUT')--}}
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($img as $i)
                                            <tr>
                                                ...
                                                <td><img width="180px" height="180px" class="rounded avatar-lg" src="{{(! empty($i->imageable_id)) ? asset('/attachments/product/'.$product->name.'/'.$i->filename) : asset('backend/assets/images/users/no_image.jpg') }}"  alt="not loading image"></td>
                                                <td>
