...
<div class="wrapper" style="font-family: 'Cairo', sans-serif; color: white;background-image: url('{{ asset('assets/images/red-light-round-podium-black-background-mock-up.jpg')}}'); ">
