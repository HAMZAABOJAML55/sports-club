...
class PlayerController extends Controller
{
    ...
    {
        $players=Player::where('coachs_id',Auth::user()->id)->get();
        return view('pages.coach.dashboard.player.index', compact('players'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.coach.dashboard.player.create', compact('nationals','Genders','locations','sub_locations','players', 'subtypes' ,'profs_degrees' ));
    }
    ...
    public function store(StorePlayerRequest $request)
    {
        try {
            ...
            return redirect()->route('coach.player.index','test');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        $profs_degrees=Prof::all();
        $subtypes =Subtype::all();
        return view('pages.coach.dashboard.player.edit', compact('subtypes','player','profs_degrees','nationals','Genders','locations','sub_locations'));
